<?header("content-type:text/html; charset=UTF-8"); ob_start;//뭔지모르겠음 이해가안감 왜쓴느지
...
$result= mysql_query($query,$connect);  //여기서 mysql쿼리가 실행되는거자나 만약 입력아디값이 데베에없으면 empty가 반환된는거자나 
$member= mysql_fetch_array($result);  //그럼 여기서도 member는 empty?  
